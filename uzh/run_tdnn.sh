...
#lm="/mnt/lorenz/data/lms/dieth_90000_open_mkn3.arpa"
lm="/mnt/lorenz/data/lms/normalised_80000_open_mkn5.arpa"

lmtype=norm80k # dieth90k, norm80K, thresh2
data_affix=dev # dev, test
...
echo
echo "*** Parameters: uzh/run_tdnn.sh ***"
echo
...
echo
echo "*** Parameters defined in file ***"
echo
echo "GPU: ${use_gpu}"
echo "Stage: ${stage}"
echo "Language model: ${lm}"
echo "LM Type: ${lmtype}"
echo "Data affix: ${data_affix}"
...
# if [ $stage -le 18 ]; then
  ...
  # # (
    ...
    # uzh/decode_nnet3_wer_cer.sh \
      ...
      # --online-ivector-dir $exp/nnet3${nnet3_affix}/ivectors_${data_affix}_set_hires \
      # $tree_dir/graph_${lmtype} \
      # $data/${data_affix}_set_hires \
